const Historico = require('../modelos/Historico');
...
const listarTareas = async (req, res) => {
    ...
    let consulta = await Historico.find({}).sort({ NOMBRE_TAREA: "desc" }).exec();
...
const listarTareasFiltroColaborador = async (req, res) => {
    ...
    let consulta = await Historico.find({ OPERADOR: colaboradorFiltro }).sort({ NOMBRE_TAREA: "desc" }).exec();
...
const listarTareasFiltroColaboradorCliente = async (req, res) => {
    ...
    let consulta = await Historico.find({ CLIENTE: clienteFiltro, OPERADOR: colaboradorFiltro }).sort({ NOMBRE_TAREA: "desc" }).exec();
...
const listarTareasFiltroColaboradorClienteActividad = async (req, res) => {
    ...
    let consulta = await Historico.find({ CLIENTE: clienteFiltro, OPERADOR: colaboradorFiltro, ACTIVIDAD: actividadFiltro }).sort({ NOMBRE_TAREA: "desc" }).exec();
...
const listarTareasFiltroCliente = async (req, res) => {
    ...
    let consulta = await Historico.find({ CLIENTE: clienteFiltro }).sort({ NOMBRE_TAREA: "desc" }).exec();
...
const listarTareasFiltroActividad = async (req, res) => {
    ...
    let consulta = await Historico.find({ CLIENTE: clienteFiltro, ACTIVIDAD: actividadFiltro }).sort({ NOMBRE_TAREA: "desc" }).exec();
...
const listarTareasFiltroActividadColaborador = async (req, res) => {
    ...
    let consulta = await Historico.find({ CLIENTE: clienteFiltro, ACTIVIDAD: actividadFiltro, OPERADOR: colaboradorFiltro }).sort({ NOMBRE_TAREA: "desc" }).exec();
...
const obtenerTarea = async (req, res) => {
    ...
    let tarea = await Historico.findById(proyectoId).exec();
...
const altaTarea = async (req, res) => {
    ...
    const tarea = new Historico(elementos_recibidos);
...
const borrarTarea = async (req, res) => {
    ...
    const delTarea = await Historico.findOneAndDelete({ _id: proyectoId }).exec();
...
const editarTarea = (req, res) => {
    ...
    //Guardar el articulo en base de datos
    Historico.findOneAndUpdate({ _id: proyectoId }, tareaUpdate, { new: true })
        .then((tareaGuardada) => {
            //Devolver resultado
...
const editarTareasSeleccionadas = async (req, res) => {
    ...
    for (var i = 0; i < TAREASSELECCIONADASRECIBIDAS.length; i++) {
        ...
        //Guardar el articulo en base de datos
        const updateTarea= await Historico.findOneAndUpdate({ _id: proyectoId }, tareaUpdate, { new: true }).exec();
